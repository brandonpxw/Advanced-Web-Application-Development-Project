<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="Payment.aspx.cs" Inherits="awad.WebForm12" %>
    ...
    <body>
        <div class="paymentcontainer">
            ...
            <div class="shipping">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage="Please enter your address." ControlToValidate="txtAddress" Font-Size="Small" ForeColor="Red"> </asp:RequiredFieldValidator>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ErrorMessage="Please enter your address." ControlToValidate="txtZipCode" Font-Size="Small" ForeColor="Red"> </asp:RequiredFieldValidator>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage="Please enter your address." ControlToValidate="txtPhoneNumber" Font-Size="Small" ForeColor="Red"> </asp:RequiredFieldValidator>
            </div>
            <br />
        ...
        <div class="rightcontainer">
            <div class="ordersummary">
                <div class="title" style="text-align: center;  font-size: 25px;">
                    Order Summary                                                                
                </div>
